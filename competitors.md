...
| 2026-08-28 | 移除御熹堂品牌：改為 PowerHero 單品牌追蹤，刪除御熹堂全部品類（魚油/蔓越莓益生菌/UC-II葡萄糖胺/膠原蛋白/紅麴）與其每日查價品項；歷史 snapshot 中的御熹堂資料一併移除（當時暫留趨勢與引用中的文字提及，已於 2026-09-10 一併清除） |
| 2026-09-10 | 御熹堂已另建獨立分析頁，本頁專注 PowerHero：清除快照資料中所有御熹堂文字提及（21 處）。改寫原則為「移除品牌但不使敘述失真」——第三方榜單引用改為不逐一列舉品牌（不從他人名單中抽掉單一品牌）、雙品牌對照句改寫為 PowerHero 單一主體、僅佐證御熹堂名次的來源連結一併移除；主體為女性保健分齡（與 PowerHero 無關）之趨勢整則刪除。註：log 中指涉競品配對的「兩品牌」（如大研／武倍）語意正確，保留 |
